...
const Protfolio = () => {
    ...
    const dataDisplay = isWideScreen ? [
        ...
        { title: "CosMos Network Earning", icon: <BsCoin />, field: 'planetUpgradeEarningAmt', isCurrency: true },
        { title: "Airdrop Refer Coin", icon: <RiBitCoinLine />, field: 'bn_airdrop_refer_coin', isCoin: true },
        { title: "CosMos Autopool Earning", icon: <BsCoin />, field: 'planetAutoPoolEarning', isCurrency: true },
        { title: "BN Reward Coin", icon: <RiBitCoinLine />, field: 'bn_reward_coin', isCoin: true },
        { title: "U. Club A Global Earning", icon: <BsCoin />, field: 'UClubAGlobalEarning', isCurrency: true },
