...
interface levelType {
  ...
  isJustNFTBought:boolean;

}


const JustNFTLevelIcon:React.FC<levelType>= ({isJustNFTBought}) => {
//  let planetBoughtLen = planetCount || 0;
  ...
  return (
    <div  className="relative w-fit  flex items-center justify-center">
      <svg width="56 " height="56 " viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect width="56" height="56" rx="28" style={svgStyles}></rect>
                 <path
                    ...
                    style={isJustNFTBought?highlightStyles:defaultStyles } stroke='black'></path>
                  <path
      ...
      <FaSpaceShuttle className='text-yellow-600 text-2xl -rotate-90'/>
...
export default JustNFTLevelIcon;
