...
export function RegMetors({logo,title,description}:MainMetorsProps) {
  return (
    <div className="">
      <div className="w-[10rem] h-[6rem] lg:w-full lg:h-full  relative max-w-xs">
        ...
        <div className={` lg:w-[28rem] relative  shadow-xl backdrop-blur-md  border border-slate-600  lg:border-[15px] lg:border-zinc-800  px-5 py-8 h-full overflow-hidden rounded-2xl flex  lg:flex-col items-center justify-center lg:items-start lg:justify-end gap-y-3`}>
        ...
        <div className="text-4xl">
          ...
          <div className={`hidden lg:block  lg:text-sm  opacity-50 text-gray-300`}>{description}</div>
          <div>
