    ...
    >
      {items.map((item, idx) => (
        ...
        >
          ...
          <Link className='bg-yellow-500 px-2 py-1 text-sm rounded-md font-semibold cursor-pointer' href={item.downloadbtn === "/CosmosSwahili.pdf"?item.downloadbtn:""} target="_blank"  rel="noopener noreferrer">
              View PDF
            </Link>
          </div>
