...
const Page = () => {
    ...
    const handleSearchUser = async (event: any) => {
        ...
        try {
            const response = await axios.post(`${process.env.NEXT_PUBLIC_URL}/user/getTierTeamUserSearch`, {
    ...
    const getTierTeam = async () => {
        try {
            const url = `${process.env.NEXT_PUBLIC_URL}/user/getTierUserlevel/${userAddress?.toLowerCase()}/${
                value.level
            }/${currentItemIndex + 1}/${value.entries}/${value.package}`;
            console.log(url);
                            ...
                            <div className="order-1 md:order-2">
                                <div className="text-right my-3 ">
                                    <p className="text-lg lg:text-xl">
                                        Business: $ {Number(totalBussience).toFixed(3)}{" "}
                                    </p>
                                </div>
                                    ...
                                    <TableBody className="bg-zinc-800 divide-y divide-gray-600 text-[10px]  lg:text-[14px]">
                                            ...
                                            <TableCell className=" py-2 whitespace-nowrap  font-medium flex items-center justify-center">
                                                <Image
                                                    ...
                                                    src={`${
                                                        ...
                                                        displayUser.searchedUser.latestPlanetName !== undefined &&
                                                        displayUser.searchedUser.latestPlanetName !== ""
                                        ...
                                        {expanded[displayUser?.searchedUser._id ?? ""] && (
                                            <TableRow className="text-white text-center">
                                                ...
                                                <TableCell colSpan={8} className="px-3 py-2 whitespace-nowrap text-sm">
                            ...
                            <div className="order-2 lg:order-1">
                                <div className="flex items-center justify-center">
                                    ...
                                    <button
                                        ...
                                        disabled={currentItemIndex === (fetchTierData?.totalPages ?? 0) - 1} // Disable if this is the last item
