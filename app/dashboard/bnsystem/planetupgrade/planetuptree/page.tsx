  ...
  <div className=''>
    ...
    <div className='bg-[#111010] w-fit relative'>
      ...
      <div className='absolute top-[29%] right-[34%]'>
        <p className="border-2 border-zinc-600   bg-black  w-fit rounded-full py-1 px-2 hover:border-yellow-400 duration-300 " data-tippy-directive="" tabIndex={0}>
          <svg
            width={22}
            height={22}
            viewBox="0 0 24 24"
      ...
      <div className='absolute bottom-[40%] right-[10%]'>
       ...
       <div className='absolute top-[0%] left-[45%]' >
        <p className="border-2 border-zinc-600   bg-black  w-fit rounded-full py-1 px-2 hover:border-yellow-400 duration-300 " data-tippy-directive="" tabIndex={0}>
          ...
          >
            <path d="M12 0L12 24M0 12L24 12" stroke="#666666" fill='#122143' strokeWidth="4" />
          </svg>
        </p>
       </div>
