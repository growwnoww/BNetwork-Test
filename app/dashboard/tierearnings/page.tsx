...
const Page = () => {
    ...
    const getTierEarningsData = async () => {
        try {
            const query = `${process.env.NEXT_PUBLIC_URL}/user/getTierEarning/${userAddress?.toLowerCase()}/${
                value.level
            }/${value.entries}/${currentItemIndex + 1}`;
    ...
    return (
        <div className="flex flex-col">
            <div className="w-full my-5 flex items-center justify-center">
                <p className="border-b-2 border-b-yellow-400 w-fit text-2xl lg:text-4xl">Tier Earnings</p>
            </div>
                    ...
                    <div className="flex flex-col items-center justify-center gap-y-6   sm:rounded-lg ">
                        <div className="w-3/4 flex flex-col gap-y-3 md:flex-row  items-center justify-around">
                            <div className="order-3 lg:order-1  w-full flex lg:flex-col   gap-x-7  items-end md:items-start ">
                                ...
                                <Input type="text" placeholder="Enter BN Id or Address" className="w-[90%] h-8" />
                            </div>
                        ...
                        <div className="w-3/4">
                            <Table className=" divide-y divide-gray-600 rounded-lg">
                                ...
                                <TableBody className="bg-zinc-800 divide-y divide-gray-600 text-[10px]  lg:text-[14px]">
                                    {tierEarnings &&
                                        tierEarnings.users.map((user, index) => {
                                            return (
                            ...
                            <div className="order-2 lg:order-1">
                                <div className="flex items-center justify-center">
                                    ...
                                    <button
                                        ...
                                        disabled={currentItemIndex === (tierEarnings?.totalPages ?? 0) - 1} // Disable if this is the last item
