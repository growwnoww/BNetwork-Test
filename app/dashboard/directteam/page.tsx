    ...
    const getDirectTeamData = async () => {
        try {
            const response = await axios(
                `${process.env.NEXT_PUBLIC_URL}/user/getDirectTeam/${userAddress?.toLowerCase()}/${
                    currentItemIndex + 1
                }/${value.entries}}`
            );
                        ...
                        <div className="w-3/4">
                            <Table className=" divide-y divide-gray-600 rounded-lg">
                                ...
                                <TableBody className="bg-zinc-800 divide-y divide-gray-600 text-[10px]  lg:text-[14px]">
                                    {directTeamData &&
                                        directTeamData.user.map((user, index) => (
                            ...
                            <div className="order-2 lg:order-1">
                                <div className="flex items-center justify-center">
                                    ...
                                    <button
                                        ...
                                        disabled={currentItemIndex === (directTeamData?.totalPages ?? 0) - 1} // Disable if this is the last item
